...
constexpr float Z_GROUND = -17.0f; // Target Y position of foot on the ground (cm) - within max reach (~22.5cm)
...
const float STEPDX=4.0f; // cm step resolution for leg trajectory
