...
constexpr float Z_GROUND = -19.0f; // Target Y position of foot on the ground (cm) - within max reach (~22.5cm)
...
constexpr float SHOULDER_WIDTH = 5.0f; // Offset from shoulder pivot to upper leg pivot (cm)(Ry)
constexpr float UPPER_LEG_LENGTH = 10.0f; // Length of upper leg (hip → knee) in cm
constexpr float LOWER_LEG_LENGTH = 10.5f; // Length of lower leg (knee → foot) in cm
